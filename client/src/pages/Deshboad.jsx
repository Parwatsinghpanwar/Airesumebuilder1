import { FilePenIcon, PenIcon, PlusIcon, TrashIcon, UploadCloud, XIcon } from 'lucide-react'
    ...
    return (
        <div>
            <div className='max-w-7x1 mx-auto px-4 py-8 '>
                <p className='text-2x1 font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden '> welcome UserName</p>
                <div className='flex gap-4'>
                    <button onClick={() => setShowCreateResume(true)} className='w-36 bg-white sm:mx-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300  group hover:border-indigo-500 hover:shadow-lg transition-all duration-300 cursor-pointer '>
                        <PlusIcon className='size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-indigo-300  to-indigo-500 text-white rounded-full ' />
                        <p className='text-sm group-hover:text-indigo-500 transition-all duration-300'>Create Resume </p>
                    </button>
                    <button onClick={() => setShowUploadResume(true)} className='w-36 bg-white sm:mx-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300  group hover:border-indigo-500 hover:shadow-lg transition-all duration-300 cursor-pointer '>
                ...
                {showCreateResume && (
                    <form
                        ...
                        className="fixed inset-0 bg-black/60 backdrop-blur z-10 flex items-center justify-center"
                    >
                        <div
                        ...
                        >
                            ...
                            <XIcon
                                className="absolute top-4 right-4 size-5 text-slate-400 hover:text-slate-600 cursor-pointer"
                                onClick={() => {
                                    setShowCreateResume(false);
                                    setTitle('');
                                }}
                        ...
                        >
                            ...
                            <div>
                                <label htmlFor="resume-input" className='block text-sm text-slate-600 '>
                                    select Resume File
                                    <div className='flex flex-col items-center justify-center gap-2 border group text-slate-400 border-slate-400 border-dashed rounded-md p-4 py-10 my-4 
